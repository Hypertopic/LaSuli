...
(function(){
	...
	var json2markup = function(json,lvl){
		...
		if(typeof json == 'object' && json instanceof Array){
			...
			for(var k in json){
				try { markup.push('<li class="object-property"><dl class="property-definition"><dt class="property-name">'+k+':<a href="#" class="property-toggle-button">[-]</a></dt><dd class="property-value">'+json2markup(json[k],lvl)+'</dd></dl></li>'); } catch(e) {}
			};
			if(markup.length == ml){
			  // rewind
			  markup.shift();
